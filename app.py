...
# IRRI logo
# ==========================
st.sidebar.image("icon/irri.png", width=160)
...
if view_choice == "Bản đồ":
  ...
  st.markdown(
      ...
      <div style="margin-top: 0px;">
          <a href="https://gis.luagao.org/mapstore/embedded.html#/143" 
            target="_blank" 
          ...
          <iframe src="https://gis.luagao.org/mapstore/embedded.html#/143" 
...
with row1_col1:
    st.markdown(
        ...
        <div style="display: flex; align-items: center; margin-bottom:5px;">
            <img src="data:image/png;base64,{get_base64_bin_file(Path("icon/productivity.png"))}"
...
with row2_col1:
    st.markdown(
        f"""
        <div style="display: flex; align-items: center; margin-bottom:5px;">
            <img src="data:image/png;base64,{get_base64_bin_file( Path("icon/sourcing.png"))}" 
                style="width: 30px; height: 30px; margin-right: 12px; vertical-align: middle;">
            <h3 style="font-size: 22px; font-weight: 200; margin: 0">
    ...
    if filtered.empty:
        ...
        if stage_choice == "Drone":
            ...
            st.markdown(
                f"""
                <div style="display: flex; align-items: center; margin-bottom:5px;">
                    <img src="data:image/png;base64,{get_base64_bin_file( Path("icon/battery.png"))}" 
                        style="width: 30px; height: 30px; margin-right: 12px; vertical-align: middle;">
                    <h3 style="font-size: 22px; font-weight: 200; margin: 0">
                        Tải trọng - Drone
                    </h3>
        ...
        # ------------------------------------------------------
            ...
            st.markdown(
                f"""
                <div style="display: flex; align-items: center; margin-bottom:5px;">
                    <img src="data:image/png;base64,{get_base64_bin_file( Path("icon/ratio.png"))}" 
                        style="width: 30px; height: 30px; margin-right: 12px; vertical-align: middle;">
                    <h3 style="font-size: 22px; font-weight: 200; margin: 0">
        ...
        # -----------------------------------------------
            ...
            st.markdown(
                f"""
                <div style="display: flex; align-items: center; margin-bottom:5px;">
                    <img src="data:image/png;base64,{get_base64_bin_file( Path("icon/water.png"))}" 
                        style="width: 30px; height: 30px; margin-right: 12px; vertical-align: middle;">
                    <h3 style="font-size: 22px; font-weight: 200; margin: 0">
...
st.markdown(
    ...
    <p style='font-size:16px; font-style:italic; color:#555; margin-top: 0px; text-align:right;'>
        Nguồn: Khảo sát của IRRI về cơ giới hóa trong sản xuất lúa vào tháng 1 năm 2026 tại 3 xã Thạnh Quới, Long Hưng, Thuận Hòa
